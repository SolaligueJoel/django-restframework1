...
PUBLIC_KEY = 'c743a66dc0d2c8400eda108cca02d650'
PRIVATE_KEY = 'fa29bdc75cf20f737d6e6194c17bb1a80c912acf'
TS = 1
...
def get_comics(request):
    ...
    off_set_limit = f"""
    <td>
        <form action"" method="post", style="visibility:{visibility};">
        <input type="submit" value="enviar valores"</div></div>
    </td >
    """
